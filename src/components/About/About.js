...
const About = () => (
  <Container className="banner_text section" id="about" fluid>
    ...
    <p>Our chefs have worked in the sushi and ramen business for over 10 years. 
        After years of experience in Japanese cuisine, ZiZi Ramen & Sushi hopes to bring a taste of Japan in your area.
    </p>
